...
struct test_case{
    ...
    void run_test(bool shallow){
        ...
        assert(bot.run_hashtest(depth) == bot.perft(depth));
        cout << fen << " SUCCESS\n";
    }
};
...
int main(){
    test_case cases[] = {
        ...
        {"4k3/8/8/pppppppp/PPPPPPPP/8/8/4K3 w - - 0 1", 5},
        ...
        {"r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1", 5},
        {"k7/8/8/8/3p1p2/8/2P1P1P1/4K3 w - - 0 1", 5},
        {"8/PPP4k/8/8/8/8/ppp4K/8 w - - 0 1", 5},
        {"r3k2r/5r2/8/8/8/8/3R4/R3K2R w KQkq - 0 1", 5}
    };
